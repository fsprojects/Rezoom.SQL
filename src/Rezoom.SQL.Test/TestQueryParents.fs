...
let ``read record folders with parent backreferences`` () =
    ...
    Assert.NotNull(folders.[0])
    Assert.Null(folders.[0].ParentFolder)
    Assert.AreEqual(1, folders.[0].Id)
    Assert.AreEqual("A", folders.[0].Name)
    Assert.NotNull(folders.[0].ChildFolders)
    Assert.AreEqual(2, folders.[0].ChildFolders.Length)

    Assert.NotNull(folders.[0].ChildFolders.[0])
    ...
    Assert.NotNull(folders.[0].ChildFolders.[0].ParentFolder)
    Assert.That(obj.ReferenceEquals(folders.[0], folders.[0].ChildFolders.[0].ParentFolder))

    Assert.NotNull(folders.[0].ChildFolders.[1])
    ...
    Assert.NotNull(folders.[0].ChildFolders.[1].ParentFolder)
    Assert.That(obj.ReferenceEquals(folders.[0], folders.[0].ChildFolders.[1].ParentFolder))

    Assert.NotNull(folders.[1])
    Assert.Null(folders.[1].ParentFolder)
    Assert.AreEqual(4, folders.[1].Id)
    Assert.AreEqual("B", folders.[1].Name)
    Assert.NotNull(folders.[1].ChildFolders)
    Assert.AreEqual(2, folders.[1].ChildFolders.Length)

    Assert.NotNull(folders.[1].ChildFolders.[0])
    ...
    Assert.NotNull(folders.[1].ChildFolders.[0].ParentFolder)
    Assert.That(obj.ReferenceEquals(folders.[1], folders.[1].ChildFolders.[0].ParentFolder))

    Assert.NotNull(folders.[1].ChildFolders.[1])
    ...
    Assert.NotNull(folders.[1].ChildFolders.[1].ParentFolder)
    Assert.That(obj.ReferenceEquals(folders.[1], folders.[1].ChildFolders.[1].ParentFolder))
