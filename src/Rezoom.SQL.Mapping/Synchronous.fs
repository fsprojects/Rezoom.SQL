...
type Extensions =
    ...
    static member Execute(cmd : Command<'a>, context : ConnectionContext) =
        cmd.Execute(context.GetConnection(cmd.ConnectionName, cmd.BackendName))
    ...
    static member ExecuteScalar(cmd : Command<#IScalar<_>>, context : ConnectionContext) =
        cmd.ExecuteScalar(context.GetConnection(cmd.ConnectionName, cmd.BackendName))
    ...
    static member ExecuteTryExactlyOne(cmd : Command<#IReadOnlyList<_>>, context : ConnectionContext) =
        cmd.ExecuteTryExactlyOne(context.GetConnection(cmd.ConnectionName, cmd.BackendName))
    ...
    static member ExecuteExactlyOne(cmd : Command<#IReadOnlyList<_>>, context : ConnectionContext) =
        cmd.ExecuteExactlyOne(context.GetConnection(cmd.ConnectionName, cmd.BackendName))