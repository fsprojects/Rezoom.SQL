...
Selecting from this table will give you a `TimeOnly` properties in your result set rows from the type provider.

Comparing to a parameter will cause that parameter to get a `TimeOnly` type:
