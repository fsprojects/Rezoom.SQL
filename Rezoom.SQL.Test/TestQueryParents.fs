namespace Rezoom.SQL.Test.QueryParents
...
type TestQueryParents() =
    ...
    member __.TestRecordFolder() =
        ...
        Assert.IsNull(folders.[0].ChildFolders.[0].ChildFolders)
        ...
        Assert.IsNull(folders.[0].ChildFolders.[1].ChildFolders)
        ...
        Assert.IsNull(folders.[1].ChildFolders.[0].ChildFolders)
